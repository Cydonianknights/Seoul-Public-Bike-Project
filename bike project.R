#Install Packages
install.packages('dplyr','plyr','caret')
...
setwd("C:/Users/TaegunKim/Desktop/Bike")
...
#bike_reg <- rename(bike_reg,c("V1" = "fail_freq")) #ERROR , 무시하고 V1을 fail_freq로 진행하기
head(bike_reg)
nrow(bike_reg)
...
logistic_bike <- subset(logistic_bike, select=-intersect)
